...
public class ServletUploadControllerV2 {
    ...
    private final ApiExceptionController apiExceptionController;

    @Value("${file.dir}")
    private String fileDir;

    ServletUploadControllerV2(ApiExceptionController apiExceptionController) {
        this.apiExceptionController = apiExceptionController;
    }
